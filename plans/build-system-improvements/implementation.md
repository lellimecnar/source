...
- [x] File contains only `24` (no extra whitespace or newlines)
- [x] Run `nvm use` in project root (if nvm is installed)
- [x] Verify correct Node version is activated: `node --version` should show v24.x.x
...
```json
{
	...
	"version": "1.0.0",
	"private": true,
	"workspaces": ["card-stack/*", "packages/*", "web/*", "mobile/*"],
	"scripts": {
