...
-   **Pattern**: **Mixin Composition**. Entities are composed of behaviors.
    -   *Example*: `class StandardCard extends Mix(Card, Flippable, Rankable)`
...
-   **Internal (Package-to-Package)**: Direct function calls via module imports.
    -   *Example*: `import { Button } from '@lellimecnar/ui/button'`
...
-   **Unit Tests**: Located alongside source files (`*.spec.ts`).
    -   *Focus*: Domain logic (`card-stack`), Utility functions.
-   **Component Tests**: Located alongside components.
    -   *Focus*: Rendering, interaction, accessibility.
